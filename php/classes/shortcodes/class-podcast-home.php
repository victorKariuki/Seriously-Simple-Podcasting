...
/**
 * Podcast app Home / Browse shortcode.
 *
 * @package Simple Podcasting
 */
class Podcast_Home implements Shortcode {

	/**
	 * Shortcode output for podcast home (browse) view.
	 *
	...
	public function shortcode( $params ) {
		...
		return ssp_renderer()->fetch( 'frontend/home', $data );
	}
}
