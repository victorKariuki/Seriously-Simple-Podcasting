Feature: SSP Plugin Extensions Settings
	...
	Scenario: All extensions exist
		...
		And I can see "These extensions add functionality to your Simple Podcasting powered podcast."
		...
		And I can see "Simple Podcasting Stats"
		...
		And I can see "Simple Podcasting Transcripts"
		...
		And I can see "Simple Podcasting Speakers"
		...
		And I can see "Simple Podcasting Genesis Support"
		And I can see "The Genesis compatibility add-on for Simple Podcasting gives you full support"
